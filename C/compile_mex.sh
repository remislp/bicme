...
then
    ...
    echo "Compiling mex file dlngevm";
    gcc  -I${MATLAB_DIR}/extern/include -I${MATLAB_DIR}/simulink/include -DMATLAB_MEX_FILE -D_GNU_SOURCE -fPIC -fno-omit-frame-pointer -pthread  -DMX_COMPAT_32 -O -DNDEBUG src/dlnvegm.c -o mex/dlnvegm.o
