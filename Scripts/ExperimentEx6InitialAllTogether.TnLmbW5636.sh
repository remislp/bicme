...
#$ -S /bin/bash
#$ -t 1-100:1
#$ -N BayesExpEx6InitialAllTogether_1
#$ -wd /home/ucbpmep/bicme
#$ -o /home/ucbpmep/bicme/Logs/BayesExpEx6InitialAllTogether_1.out 
#$ -e /home/ucbpmep/bicme/Logs/BayesExpEx6InitialAllTogether_1.err
