...
#$ -S /bin/bash
#$ -t 1-100:1
#$ -N BayesExpEx5InitialAllTogetherPerfectResolution_1
#$ -wd /home/ucbpmep/bicme
#$ -o /home/ucbpmep/bicme/Logs/BayesExpEx5InitialAllTogetherPerfectResolution_1.out 
#$ -e /home/ucbpmep/bicme/Logs/BayesExpEx5InitialAllTogetherPerfectResolution_1.err

#pre matlab scripting
echo "script started at"
echo Tue Mar 31 14:39:55 BST 2015
echo ""
date1=$( date +"%s" )
...
/share/apps/matlabR2013a/bin/matlab -nodisplay -nodesktop -nosplash -r "try addpath(genpath(pwd));fprintf('SGE %d\n',${SGE_TASK_ID});rng(${SGE_TASK_ID});Ex5InitialAllTogetherPerfectResolution(${SGE_TASK_ID});catch err; disp(err.message); end; quit();"
